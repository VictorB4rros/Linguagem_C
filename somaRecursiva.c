...
int soma (int n) // Função soma sem usar a recursividade
{
	int resultado;
	resultado = 0;
	if (n != 0)
...
int main()
{
	...
	{
		system("cls");
		printf("\nEste programa calcula a soma de todos os valores inteiros entre 1 e n, onde n eh fornecido pelo usuario.");
	...
	printf("\n\nO valor da soma usando a funcao recursiva eh: %d", soma_recursiva(n));
